...
class CUP$parser$actions {
 ...
 if(modoDepuracion) System.out.println("\t regla 6 parte del medio"); 
		...
		RESULT = new NodoVariable(variable.toString());
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("var_stmt",12, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;

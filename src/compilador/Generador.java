...
public class Generador {
	...
	private static void generarReturn(NodoBase a, String ambito) {
		...
		{									
			...
			UtGen.emitirRM("LD", UtGen.AC, var.getDireccionMemoria()+((NodoIdentificador)((NodoReturn)a).getId()).getPos(),UtGen.AC1, "Descargando Valor de: "+ambito+"."+((NodoIdentificador)((NodoReturn)a).getId()).getNombre());						
			UtGen.emitirRM("LDA", UtGen.PC, 0, UtGen.R3, "Devolver Direccion de retorno");
		}					
